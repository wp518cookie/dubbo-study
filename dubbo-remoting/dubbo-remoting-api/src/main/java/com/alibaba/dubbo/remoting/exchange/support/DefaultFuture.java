...
public class DefaultFuture implements ResponseFuture {
    ...
    static {
        Thread th = new Thread(new RemotingInvocationTimeoutScan(), "DubboResponseTimeoutScanTime");
        th.setDaemon(true);
        th.start();
    }
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    logger.error("Exception when scan the timeout invocation of remoting.");
                }
            }
        }
    }
