...
public abstract class AbstractInterfaceConfig extends AbstractMethodConfig {
    ...
    private static final long serialVersionUID = 582526803739350375L;
    ...
    /**
     * 服务提供方远程调用过程拦截器名称，
     * 多个名称用逗号分隔，Spring拦截器可以拦截Web接口，
     * 无法拦截dubbo接口，但是dubbo提供了Filter扩展
     */
